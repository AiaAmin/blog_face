...
namespace Dal.pgDB {
    public sealed class MorafikContext : DbContext {
        protected override void OnConfiguring (DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseNpgsql (@"Server=localhost;Database=morafik;Username=postgres;Password=747774909");
